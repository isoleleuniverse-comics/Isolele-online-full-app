...
export const translations: Record<Language, TranslationKeys> = {
  ...
  pt: {
    ...
    footer_copyright: "© 2026 Isolele. Todos os direitos reservados. Uma iniciativa do patrimônio congolês.",
  ...
  es: {
    ...
    footer_copyright: "© 2026 Isolele. Todos los derechos reservados. Una iniciativa del patrimonio congoleño.",
    footer_press: "Prensa",
  ...
  zu: {
    ...
    footer_copyright: "© 2026 Isolele. Wonke amalungelo agodliwe. Umsebenzi Womkhosi Wakekongo.",
  ...
  xh: {
    ...
    nav_founder: "Umseki",
    nav_news: "Iindaba",
    nav_characters: "Amaxhosa",
    nav_shop: "Ivenkile",
    nav_supporters: "Abaxhasa",
    nav_contact: "Xhumana",
    nav_games: "Imidlalo",
    nav_all_characters: "Bonke Amaxhosa",
    nav_become_supporter: "Ba Nenkosikazi Yokusetyenzela",
    nav_partners: "AbakwaSahlele",
    nav_restaurant: "Ibango",
    nav_fashion: "Umzebenzi",
    nav_settings: "Iisetingi",
    
    // Hero Section (Xhosa)
    hero_title: "WANIKWA KU-ISOLELE",
    hero_subtitle: "INDALO EPHELELEYO EYAZALWA KWIZIXHOBO ZEKONIGO...",
    hero_description: "I-Isolele yindalo enomdla eyazalwa ukubuyisela umphefumlo webali lase-Afrika, imimandla ayibaliswanga, kunye namandla omzi.",
    hero_buy_now: "THENGA NGOKU",
    hero_discover: "PHONONONGA",
    hero_preorder: "ISILINGANISO ESISALHUKE",
    hero_launch_price: "Ixabiso Lokusukela",

    // Book Slides (Xhosa)
    book_welcome_tag: "WANIKWA KU-ISOLELE",
    book_chosen_ones_title: "ABANYULIWEYO",
    book_chosen_ones_subtitle: "Indalo epheleleyo eyazalwa kwizixhobo zaseKongo...",
    book_chosen_ones_desc: "I-Isolele yindalo enomdla eyazalwa ukubuyisela umphefumlo webali lase-Afrika, imimandla ayibaliswanga, kunye namandla omzi obasetshenziswa kwindawo. Omntwana ongu mfundi i-Isolele uzakufumana amaxhosa abakekeza naye, abantu abesilwela ilizwe labo, kunye neqabane labo. Oku kuwu inkwelo yeminye imisebenzi, imikhosi, abolumko, kunye nabaSomi.",
    book_explore_universe: "PHONONONGA INDALO",

    book_makanda_tag: "UBUKHOSI BUKAMAKANDA — INCWADI I",
    book_makanda_title: "MAKANDA",
    book_makanda_subtitle: "UMBUZO OLUSEMANDLENI KAKHULU KUZWANDLE WAYENAZANGE ALAHLEKILE. WAFIHLWE NGENYE INDLELA.",
    book_makanda_desc: "Kwixesha elidlulileyo ene-Afrika, kwakhona omnye umntu okwayenazange wayazi umhlaba. Ivuma kuhamba. Imishini yepiki. Evikele iNqamulelo Engcwele. Lapho amandla angaphandle afikile, abaMakanda abalandeli. Balahlahlela. Isixeko sabo asikuphumelele. Belilinde umuntu ozaliwe ukhonza iNqamulelo kabusha.",
    book_discover_makanda: "FUMANA MAKANDA",

    book_bambula_tag: "BAMBULA: UMNTWANA WOMSINDO",
    book_bambula_title: "BAMBULA",
    book_bambula_subtitle: "ISAHLUKO I · ISIHLALELO ESIKHULU",
    book_bambula_desc: "Phambi kwamabali, kwakukho umsindo. UBambula wayenazange wayazi umuntu. Kwaphakama kwaye kubo abasebenzi abayabula. Apho amagubgu abeningqobo namlama wayehluleka, wahambe agcina umsindo uphilile ngaphakathi kwakhe. Ezinzula yomundu ogcile, uhamba phakathi komuntu nokomelela. Akukho umfo ekuthi akulandelele. Uvikela ukuba kukhumbule.",
    book_discover_bambula: "FUMANA BAMBULA",

    book_mokele_tag: "MOKELE: WAZALWA EKULWANENI",
    book_mokele_title: "MOKELE",
    book_mokele_subtitle: "UKUSUKA KUMNTWANA UKUYA KUMKHOSI WEKINSHASA",
    book_mokele_desc: "UMokele wayenazange wazalwa njengomNkosi. Wayenazange wazalwa kumlobi. Ekuseni kwendile eKivu Esentshonalanga. Wava nentuthwane ekwindawo yabantu, ekuze kwenzela ubnini botho. Apho amagubgu abeningqobo wayehluleka, wahambe agcina umntwana ophilile ngaphakathi. Wamkele umuntu ekuseni. Akacingelwa. Ukhumbule umuntu omntwana.",
    book_discover_mokele: "FUMANA MOKELE",

    book_zaiire_tag: "ZAIIRE: INKOSANA YAKONGO",
    book_zaiire_title: "INKOSANA YAKONGO",
    book_zaiire_subtitle: "UMXHOLO WESIPHELO",
    book_zaiire_desc: "Enkulu-inzalo yabalindwa ngabantu abaninzi noxolo. Ukhumbule umlibane. Ukhumbule umuntu oyancoma. Ukhumbule inkosi. Ukhumbule abantwana. Ukhumbule ilizwe. Ukhumbule abantu. Ukhumbule umuntu omchole. Ukhuze umuntu. Wazalwa ekuseni. Igama lakhe lalula ngabantu. Igama lakhe lalula kumuntu. Igama lakhe lalula kwilizwe.",
    book_discover_zaiire: "FUMANA ZAIIRE",

    book_kufu_tag: "KUFU: UMDLALO WEKHOSI",
    book_kufu_title: "KUFU",
    book_kufu_subtitle: "UMDLALO WANGCACISO WEINDALO YE-ISOLELE",
    book_kufu_desc: "Ayisosindisi kuphela i-card game. Kusisindiso kwesindiso nesiniyeli. Umuntu omthembile owazi ukuba ukhumbule umuntu. Umuntu owazi ukuba uzakuzwa umuntu. Umuntu owazi ukuba uzakubona umuntu. Umuntu owazi ukuba uzakuchutha umuntu. Umuntu owazi ukuba uzakuvikela umuntu.",
    book_explore_game: "PHONONONGA UMDLALO",

    book_amara_tag: "AMARA: KUMKANIKAZI WASOLWANDLE",
    book_amara_title: "AMARA",
    book_amara_subtitle: "ISAHLUKO I · KUMKANIKAZI WEAMAZON PIRATES",
    book_amara_desc: "Wonke umqwebu uyatshaba olulamda. Umuntu omthembile onokuthembisa ilizwe. Umuntu owazi ukuba umuntu. Umuntu owazi ukuba uzakuthembisa umuntu. Umuntu owazi ukuba uzakunikwa umuntu. Umuntu owazi ukuba uzakutshintsha umuntu. Umuntu owazi ukuba uzakubuyisela umuntu.",
    book_discover_amara: "FUMANA AMARA",

    book_zattar_tag: "ZATTAR: INKOSANA YEINDALO",
    book_zattar_title: "ZATTAR",
    book_zattar_subtitle: "UMHWELI WEENTHASI",
    book_zattar_desc: "Xa umoya wayikhangelisa umnye ubukhosi. Umuntu omthembile owazi ukuba ukhumbule umuntu. Umuntu owazi ukuba uzakuthembela umuntu. Umuntu owazi ukuba uzakufa umuntu. Umuntu owazi ukuba uzakuvula umuntu. Umuntu owazi ukuba uzakuthembisa umuntu.",
    book_discover_zattar: "FUMANA ZATTAR",

    book_zaiko_tag: "ZAÏKO: UKUMKOSI WOKUGUMIRA WEENDLELA ZEZIVU",
    book_zaiko_title: "ISIKHUMBUZO SIKA-ZAÏKO",
    book_zaiko_subtitle: "WAYENAZANGE WAVUKA KWINDLELA. WAZITHATHELA INZELA.",
    book_zaiko_desc: "Wazalwa eKivu Esentshonalanga. Wava nentuthwane ekwindawo yabantu, ekuze kwenzela ubnini botho. Awukutshintsha isindlela. Awukutshintsha umuntu. Awukutshintsha ilizwe. Awukutshintsha abantu. Awukutshintsha indawo. Akukho umfo ekuthi akulandelele. Uvikela ukuba kukhumbule.",
    book_discover_zaiko: "FUMANA ZAÏKO",
    
    // Universe Section (Xhosa)
    universe_title: "INDALO",
    universe_subtitle: "PHONONONGA INDALO",
    universe_description: "I-Isolele yindalo enomdla eyazalwa ukubuyisela umphefumlo webali lase-Afrika, imimandla ayibaliswanga, kunye namandla omzi.",
    universe_destiny_title: "ISIPHAKAMISO",
    universe_destiny_desc: "Isiphakamiso esikhokelela kwimizekelo yasekuseni.",
    universe_heritage_title: "ILIZWANDLE",
    universe_heritage_desc: "Ilizwandle likukhumbule abantu basekuseni.",
    universe_resurrection_title: "UBUYEKEZO",
    universe_resurrection_desc: "Ubuyekezo kwabenyama abakhondene neqabane.",
    
    // Characters Section (Xhosa)
    characters_title: "AMAXHOSA",
    characters_subtitle: "PHONONONGA AMAXHOSA",
    characters_discover: "FUMANA INXWELO",
    characters_zaire_title: "ZAIIRE",
    characters_zaire_desc: "Inkosana yakongo eyayiquqilaza impi.",
    characters_kimoya_title: "KIMOYA",
    characters_kimoya_desc: "Umuntu omthembile owazi ukuba ukhumbule.",
    characters_zattar_title: "ZATTAR",
    characters_zattar_desc: "Umhweli weenthasi owazi ukuba uzakutshintsha ilizwe.",
    characters_twins_title: "ABAZALI",
    characters_twins_desc: "Abantu ababini abazaliweyo ngobungenelelo.",
    characters_imvula_title: "IMVULA",
    characters_imvula_desc: "Umuntu omthembile owazi ukuba uzakuvikela ilizwe.",
    
    // News Section (Xhosa)
    news_title: "IINDABA",
    news_read_more: "FUNDA OKWANGESINYE",
    news_minutes_read: "Iminuthi Yokubuthetha",
    news_published: "Ipapashwe",
    
    // CTA Section (Xhosa)
    cta_title: "ZIYAMELE EKILINIJINI",
    cta_join_legend: "SIYAJOYINA INGQUMBUZO",
    cta_description: "Ngoku ziyamele ekilinijini nabantu abayabulela ilizwe.",
    cta_explore: "PHONONONGA NGOKU",
    cta_newsletter: "IINCWADI ZESIQALO",
    
    // Footer (Xhosa)
    footer_description: "I-Isolele yindalo enomdla eyazalwa ukubuyisela umphefumlo webali lase-Afrika.",
    footer_explore: "PHONONONGA",
    footer_resources: "IZINTO EZIPHAKAMILEYO",
    footer_newsletter_title: "IINCWADI ZESIQALO",
    footer_newsletter_desc: "Ziyamele ekilinijini nabantu abayabulela ilizwe.",
    footer_email_placeholder: "Imel yakho",
    footer_subscribe: "ZIYAMELE",
    footer_copyright: "© 2026 Isolele. Amalungelo onke akalihlile. Umsebenzi Wentuthuko Yekonigo.",
    footer_press: "Iphephandaba",
    footer_careers: "IMISEBENZI",
    footer_contact: "Xhumana",
    footer_faq: "IMIBUZO",
    footer_terms: "IMIGAQO",
    footer_privacy: "UBUYAMUKELI",
    
    // Shop (Xhosa)
    shop_title: "IVENKILE",
    shop_subtitle: "THINTELELA INKATHISA YETHU",
    shop_add_to_cart: "YONGEZA EKHARTINI",
    shop_buy_now: "THENGA NGOKU",
    shop_price: "IXABISO",
    shop_sale: "UTHENGE",
    shop_new: "ENTSHA",
    shop_bestseller: "EYENZIWE KAKHULU",
    
    // Cart (Xhosa)
    cart_title: "IKHARTHI",
    cart_empty: "IKHARTHI YAKHO IYONKE",
    cart_subtotal: "ISIXENXE",
    cart_shipping: "UKUNTHWALA",
    cart_total: "YOKUPHELELEYO",
    cart_checkout: "XOKELELA",
    cart_continue_shopping: "QHUBEKELA PHAMBI NOKUSHINTSHELA",
    cart_remove: "SUSA",
    cart_quantity: "UBUNGAKANANI",
    
    // Payment (Xhosa)
    payment_title: "IMALI",
    payment_card: "IKHADI LEMALI",
    payment_google_pay: "GOOGLE PAY",
    payment_card_number: "INOMBORO YEKHADI",
    payment_expiry: "INKATHI YOKUPHELELISWA",
    payment_cvv: "CVV",
    payment_name: "IGAMA LOMUNTU ONENKHADI",
    payment_email: "I-IMEL",
    payment_confirm: "QINISEKISA IMALI",
    payment_success: "IMALI IYAPHUMELELE!",
    payment_receipt_sent: "IQINISEKISO LETHU LALITHUMELA KWI-IMEL YAKHO",
    
    // About (Xhosa)
    about_title: "MALUNGA NE-ISOLELE",
    about_what_is: "YI-ISOLELE YINTONI?",
    about_vision_title: "UMBONO",
    about_vision_desc: "BUYISELA I-AFRIKA NJENGESOSELA SEBALI, IINGQONDO, NAMANDLA.",
    about_pillars_title: "IIKHONI EZINE ZEISOLELE",
    about_pillar1_title: "UMHLABA WENGQONDO",
    about_pillar1_desc: "IIGAZI NEMIKHOSI YOLEKELELA UBUKHOSI BUYONTSHA I-AFRIKA.",
    about_pillar2_title: "IIMPAWU EZILUNGILEYO KUNYE NOKUSETYENZISWA KWIINDAWO",
    about_pillar2_desc: "UKUSUKA KWIBALI KUYA KUINGCAMANGO, IMIDLALO UKUYA KUSINESIMA, I-ISOLELE ISENZA ISITISHI SEBASEBENZI BE-AFRIKA.",
    about_pillar3_title: "UKUVUKA KWAMUNTU",
    about_pillar3_desc: "I-ISOLELE YINXALENYE YOKUGQIBELA YESISOMBULULO ESIKHULU ESIKUQULUNGQISELA, UKUPHUHLISA, KUNYE NOKUBUYISELA UBUKHOSI BE-AFRIKA.",
    about_pillar4_title: "IZANDO ZABANTWANA",
    about_pillar4_desc: "OMNTWANA OFUNDAYO I-ISOLELE UZAKUFUMANA AMABALI ABUKEKA NAYE.",
    founder_title: "UMSEKI",
    founder_name: "UMKOSI UKULULU",
    founder_role: "UMUSEKI KUNYE NOMUNTU OBUBHALO BE-ISOLELE UNIVERSE",
    founder_bio: "UMENZI OSETYENZISWA KWI-ISOLELE, OZINIKELE EKUBUYISELENI UMPHEFUMLO WEBALI LASE-AFRIKA KUNYE NOKUQHELANISA UBUKHOSI OBASE-AFRIKA.",
    
    // Common (Xhosa)
    language: "ULWIMI",
    theme: "ISIFUSHO",
    discover: "FUMANA",
    latestNews: "IINDABA ZAMVA",
    loading: "IMISELWA.",
    error: "IMPOSISO",
    success: "ILUNGILE",
    cancel: "ZIHOXE",
    ...
    delete: "CIMA",
    search: "FUNELA",
    search_placeholder: "FUNELA...",
    view_all: "BUKA KONKE",
    learn_more: "FUNDA UKUBHALI OKUNGESINYE",
    back: "BUYELA EMVA",
    next: "OKULANDELAYO",
    previous: "OKWANDULELA",
    site_map: "IMAPHU YESAYT",
  ...
  sw: {
    ...
    footer_copyright: "© 2026 Isolele. Haki zote zimehifadhiwa. Mradi wa Utamaduni wa Kongo.",
  ...
  ln: {
    ...
    nav_founder: "Mosungi",
    nav_news: "Sango",
    nav_characters: "Basaleli",
    nav_shop: "Magazini",
    nav_supporters: "Abaxhasa",
    nav_contact: "Kontakti",
    nav_games: "Masolo",
    nav_all_characters: "Basaleli Nyonso",
    nav_become_supporter: "Ba Nenkosikazi Yokusetyenzela",
    nav_partners: "Bamomikitani",
    nav_restaurant: "Likolo",
    nav_fashion: "Motuya",
    nav_settings: "Mibeko",
    
    // Hero Section (Lingala)
    hero_title: "KAABO KU ISOLELE",
    hero_subtitle: "MOKILI MOSUSU WAZALI NA EZALI KOYAKA MAKILA YA KONGO...",
    hero_description: "Isolele ezali mokili moko ya boyebi oyo ebotamaki mpo na kozongisa molimo ya masolo ya Afrika, manzanza na nguya.",
    hero_buy_now: "SOMA SIKA",
    hero_discover: "TALELA",
    hero_preorder: "LILANDA SIKA",
    hero_launch_price: "Liyale ya Kokuma",

    // Book Slides (Lingala)
    book_welcome_tag: "KAABO KU ISOLELE",
    book_chosen_ones_title: "BAPONAMI",
    book_chosen_ones_subtitle: "Mokili mosusu wazali na ezali koyaka makila ya Kongo...",
    book_chosen_ones_desc: "Isolele ezali mokili moko ya boyebi oyo ebotamaki mpo na kozongisa molimo ya masolo ya Afrika, manzanza, na nguya. Mwana oyo akofunda ISOLELE akoyeba basaleli oyo ba ko-elingela ye, abantu ba kosala motema, kunene na bampela. Oyo nde ebele ya balisele, mikholo, mabikili, na banyami.",
    book_explore_universe: "TALELA MOKILI",

    book_makanda_tag: "BOKONZI BYA MAKANDA — BUKU I",
    book_makanda_title: "MAKANDA",
    book_makanda_subtitle: "MBUZI YA BOKONZI OYO EZALI MINENE SOKI EKUFA LIKAMBO. EFILAMAKI NA MAYELE.",
    book_makanda_desc: "Kati ya Afrika Etikali kulikuwa na tamaduni ulimwengu ulihifadhiwa asiwe najua. Iliyoamkia kiroho. Iliyoendelea kwa teknolojia. Iliyolindwa na Moto Mtakatifu. Wakati Nguvu za Nje zikaja kwa nini lilikuwa lao, Makanda hawakukufa. Walianguka. Jiji lao halilipotea. Ilikuwa ikingoja yule ambaye alizaliwa kuuzisha Moto tena.",
    book_discover_makanda: "YEBA MAKANDA",

    book_bambula_tag: "BAMBULA: MWANA YA RITEM",
    book_bambula_title: "BAMBULA",
    book_bambula_subtitle: "CHAPIT I · LIBANGA LISAKOLI",
    book_bambula_desc: "Liboso ya nzembo, ezalaki ritem. Bambula azali kobotama te lokola mwana. Apho makambo ya ritem eyalakela, alingaki ritem na likambo. Elaki yango nzela yango nzela. Azali lisilisi lokola basaleli oyo ba ko-lisilisa. Molendo osalaki nini oyo ba kanda. Akobinda likambo lokola akobinda miembe.",
    book_discover_bambula: "YEBA BAMBULA",

    book_mokele_tag: "MOKELE: AZALI MOBIMAMBO NA MOLENDE",
    book_mokele_title: "MOKELE",
    book_mokele_subtitle: "WUTA NA MWANA KINO MOBOTI YA KINSHASA",
    book_mokele_desc: "Mokele azali kobotama te lokola Mokonzi. Azali na likambo lya Kivu Esentshonalanga. Alingaki bato, ekuze kwenzela ubnini botho. Apho amagubgu ayalakela, alonje ritem na likambo. Alingaki mwana na likambo. Akobinda likambo lokola moto oyo ba katema.",
    book_discover_mokele: "YEBA MOKELE",

    book_zaiire_tag: "ZAIIRE: MWANA YA MOKONZI YA KONGO",
    book_zaiire_title: "MWANA YA MOKONZI YA KONGO",
    book_zaiire_subtitle: "SINGA YA MOKANO",
    book_zaiire_desc: "Eyalembwe na likita ya Bokonzi ya Kongo, Singa ya Mokano eyalembwe mpo azali mwa esengo. Akoyeba bamelani. Akoyeba bato. Akoyeba mokonzi. Akoyeba bana. Akoyeba mokili. Akoyeba bato. Akoyeba moto oyo ba malua. Azomeli moto. Azali na Kivu Esentshonalanga.",
    book_discover_zaiire: "YEBA ZAIIRE",

    book_kufu_tag: "KUFU: MOSOLO YA MWANI",
    book_kufu_title: "KUFU",
    book_kufu_subtitle: "MOSOLO YA OFFICIEL YA MOKILI YA ISOLELE",
    book_kufu_desc: "Eyokatani te kuphela na mosolo ya kadi. Kusisindiso kwesindiso nesiniyeli. Moto oyo ba katema owazi ukuba ukhumbule moto. Moto owazi ukuba uzakuzwa moto. Moto owazi ukuba uzakubona moto. Moto owazi ukuba uzakuchutha moto. Moto owazi ukuba uzakuvikela moto.",
    book_explore_game: "TALELA MOSOLO",

    book_amara_tag: "AMARA: MOKONZI MWASI YA ZINZINIBA",
    book_amara_title: "AMARA",
    book_amara_subtitle: "CHAPIT I · MOKONZI YA BANDOKI YA AMAZON",
    book_amara_desc: "Bandoki nyonso bakoyaka zinziniba. Moto oyo ba katema onoki kotambisa mokili. Moto owazi ukuba moto. Moto owazi ukuba uzakuthembela moto. Moto owazi ukuba uzakunikwa moto. Moto owazi ukuba uzakutshintsha moto. Moto owazi ukuba uzakubuyisela moto.",
    book_discover_amara: "YEBA AMARA",

    book_zattar_tag: "ZATTAR: MWANA YA MOKONZI YA MOKILI",
    book_zattar_title: "ZATTAR",
    book_zattar_subtitle: "MAKOSI YA MIPANGO",
    book_zattar_desc: "Soki Mokano azangi kopesa ye bokonzi moko. Moto oyo ba katema owazi ukuba ukhumbule moto. Moto owazi ukuba uzakuthembela moto. Moto owazi ukuba uzakunikwa moto. Moto owazi ukuba uzakuvula moto. Moto owazi ukuba uzakuthembisa moto.",
    book_discover_zattar: "YEBA ZATTAR",

    book_zaiko_tag: "ZAÏKO: MOKONZI YA SUKA YA KIVU",
    book_zaiko_title: "LISOLO YA ZAÏKO",
    book_zaiko_subtitle: "AZANGI KONINGANA WUTA SUKA. AZANGI KOPESA YANGO NZELA.",
    book_zaiko_desc: "Azali na Kivu Nzela ya Nor. Alingaki bato, ekuze kwenzela ubnini botho. Akotshintsha nzela. Akotshintsha moto. Akotshintsha mokili. Akotshintsha bato. Akotshintsha ndako. Akobinda likambo lokola moto oyo ba katema. Akovikela likambo.",
    book_discover_zaiko: "YEBA ZAÏKO",
    
    // Universe Section (Lingala)
    universe_title: "MOKILI",
    universe_subtitle: "TALELA MOKILI",
    universe_description: "Isolele ezali mokili moko ya boyebi oyo ebotamaki mpo na kozongisa molimo ya masolo ya Afrika, manzanza, na nguya.",
    universe_destiny_title: "ELANGELI",
    universe_destiny_desc: "Elangeli oyo elingi libanda ya koyaka.",
    universe_heritage_title: "ILIZWANDLE",
    universe_heritage_desc: "Ilizwandle likukhumbule abantu basekuseni.",
    universe_resurrection_title: "UBUYEKEZO",
    universe_resurrection_desc: "Ubuyekezo kwabenyama abakhondene neqabane.",
    
    // Characters Section (Lingala)
    characters_title: "BASALELI",
    characters_subtitle: "TALELA BASALELI",
    characters_discover: "YEBA ETUMBU",
    characters_zaire_title: "ZAIIRE",
    characters_zaire_desc: "Mwana ya Mokonzi ya Kongo eyayilukamela mpi.",
    characters_kimoya_title: "KIMOYA",
    characters_kimoya_desc: "Moto oyo ba katema owazi ukuba ukhumbule.",
    characters_zattar_title: "ZATTAR",
    characters_zattar_desc: "Makosi ya Mipango owazi ukuba uzakotshintsha mokili.",
    characters_twins_title: "BANA BABILI",
    characters_twins_desc: "Batu ababili babiliwe na nzela.",
    characters_imvula_title: "IMVULA",
    characters_imvula_desc: "Moto oyo ba katema owazi ukuba uzakuvikela mokili.",
    
    // News Section (Lingala)
    news_title: "SANGO",
    news_read_more: "FUNDA OYO ETE",
    news_minutes_read: "Minutu ya Okubuthetha",
    news_published: "Oshile",
    
    // CTA Section (Lingala)
    cta_title: "ZIYAMELE EKILINIJINI",
    cta_join_legend: "SIYAJOYINA INGQUMBUZO",
    cta_description: "Sika ziyamele ekilinijini oyo bato bayelaka mokili.",
    cta_explore: "TALELA SIKA",
    cta_newsletter: "IINCWADI ZESIQALO",
    
    // Footer (Lingala)
    footer_description: "Isolele ezali mokili moko ya boyebi oyo ebotamaki mpo na kozongisa molimo ya masolo ya Afrika.",
    footer_explore: "TALELA",
    footer_resources: "IZINTO EZIPHAKAMILEYO",
    footer_newsletter_title: "IINCWADI ZESIQALO",
    footer_newsletter_desc: "Sika ziyamele ekilinijini oyo bato bayelaka mokili.",
    footer_email_placeholder: "Imel yakho",
    footer_subscribe: "ZIYAMELE",
    footer_copyright: "© 2026 Isolele. Amalungelo onke alondolozwa. Likabelo Lomasango Wakongo.",
    footer_press: "Iphephandaba",
    footer_careers: "IMISEBENZI",
    ...
    // Shop (Lingala)
    shop_title: "MAGAZINI",
    shop_subtitle: "TALA KOLEKSYON NA BISO YA BD",
    shop_add_to_cart: "TIKELA NA KETE",
    shop_buy_now: "SOMA SIKA",
    shop_price: "LIYALE",
    shop_sale: "LISOMO",
    shop_new: "LIMAO",
    shop_bestseller: "LIMAMBI TE",
    
    // Cart (Lingala)
    cart_title: "KETE",
    cart_empty: "KETE NA YO EZALI LIBANDA",
    cart_subtotal: "KATI",
    cart_shipping: "KOKATISA",
    cart_total: "LOPESANI",
    cart_checkout: "KOMEKA",
    cart_continue_shopping: "BUTSIRA MOSOLO NA KOMEKA",
    cart_remove: "BONDA",
    cart_quantity: "MOTANGO",
    
    // Payment (Lingala)
    payment_title: "MATONDO",
    payment_card: "KAADI YA BANKI",
    payment_google_pay: "GOOGLE PAY",
    payment_card_number: "NAMBELE YA KAADI",
    payment_expiry: "NTANGO YA KOKELA",
    payment_cvv: "CVV",
    payment_name: "LIYINA LA MOTO WA KAADI",
    payment_email: "EMAIL",
    payment_confirm: "KIMBAKIMBA MATONDO",
    payment_success: "MATONDO EYE EYAKI YANGO!",
    payment_receipt_sent: "LIYAKANI LATUMAMAKI NA IMEL NA YO",
    
    // About (Lingala)
    about_title: "MALUNGA NA ISOLELE",
    about_what_is: "ISOLELE EZALI NINI?",
    about_vision_title: "BOYEBI",
    about_vision_desc: "KOZONGISA AFRIKA LOKOLA MOTINDO YA MASOLO, MANZANZA, NA NGUYA.",
    about_pillars_title: "LIKANDA INE YA ISOLELE",
    about_pillar1_title: "MOKILI WA MOLIMO",
    about_pillar1_desc: "EZALI PELE NA MOKONZI NA MOKONZI MWASI OYO BA KO-ATINDI BUKONZI YA AFRIKA MUTU NOKI NYONSO.",
    about_pillar2_title: "KOLIMBUKA KREASI MAPE NA ESENGO YE NDAKO",
    about_pillar2_desc: "WUTA MASOLO KINO MANZANZA, MOSOLO KINO SINEMA, ISOLELE ESALI NDAKO YA BASALI YA CREASI YA AFRIKA.",
    about_pillar3_title: "KUMVUA KWA MOTO",
    about_pillar3_desc: "ISOLELE EZALI ESANGO YA LIBOSO YA MONINGA MONENE OYO EZONGISELAKA, KOFUTA, MEP KOZONGISA MOKILI, MOLIMO YA AFRIKA.",
    about_pillar4_title: "ZIPANU ZA BANA",
    about_pillar4_desc: "MWANA OYO AKOFUNDA ISOLELE AKOYEBA BASALELI OYO BA KO-ELINGELA YE.",
    founder_title: "MOSUNGI",
    founder_name: "MOKONZI KUFULULU",
    founder_role: "MOSUNGI MEP MOZANGI YA ISOLELE UNIVERSE",
    founder_bio: "MUNINGA OYO AZALI LIKOLO YA ISOLELE, OZINIKI MEP NA KOZONGISA MOLIMO YA MASOLO YA AFRIKA MAPE.",
    ...
    delete: "BONDA",
    search: "TALA",
    search_placeholder: "TALA...",
    view_all: "TALA NYONSO",
    learn_more: "FUNDA OYO ETE",
    back: "KOZONGA",
    next: "OYO ELANDI",
    previous: "OYO ELEKI",
  ...
  zh: {
    ...
    footer_copyright: "© 2026 Isolele. 版权所有。一项刚果遗产倡议。",
    ...
    payment_success: "付款成���！", payment_receipt_sent: "收据已发送至您的电子邮件",
  ...
  hi: {
    ...
    footer_copyright: "© 2026 Isolele. सर्वाधिकार सुरक्षित। एक कांगो विरासत पहल।",
  ...
  ru: {
    ...
    footer_copyright: "© 2026 Isolele. Все права защищены. Инициатива конголезского наследия.",
  ...
  ja: {
    ...
    footer_copyright: "© 2026 Isolele. 著作権所有。コンゴの遺産イニシアチブ。",
  ...
  ar: {
    ...
    footer_copyright: "© 2026 Isolele. جميع الحقوق محفوظة. مبادرة التراث الكونغولي.",
  ...
  bn: {
    ...
    footer_copyright: "© 2026 Isolele. সমস্ত অধিকার সংরক্ষিত। একটি কঙ্গো ঐতিহ্য উদ্যোগ।",
  ...
  ur: {
    ...
    footer_copyright: "© 2026 Isolele. تمام حقوق محفوظ ہیں۔ ایک کانگو ورثہ کا منصوبہ۔",
  ...
  om: {
    ...
    footer_copyright: "© 2026 Isolele. Midhaan hundeeffame. Haasawa Garaa Congoo.",
  ...
  ha: {
    ...
    footer_copyright: "© 2026 Isolele. Hanad Dhamaalkaab. Masharuuca Dedka Congoo.",
  ...
  yo: {
    ...
    footer_copyright: "© 2026 Isolele. Gbogbo Ẹtọ Ti Lòdì. Ero Asa Congo.",
  ...
  sn: {
    ...
    footer_copyright: "© 2026 Isolele. Haki Dzose Dzakarudzwa. Chirongwa cheChimvini cheCongo.",
  ...
  ig: {
    ...
    footer_copyright: "© 2026 Isolele. Onwu Iwu Gụzọ. Imewe Omenala Congo.",
  ...
  am: {
    ...
    footer_copyright: "© 2026 Isolele. ሁሉም መብቶች የተጠበቁ። የኮንጎ ውርስ ጉባኤ።",
