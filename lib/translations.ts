...
export interface TranslationKeys {
  ...
  fr: {
    ...
    cta_description: "Faites partie d'un univers de bande dessinée révolutionnaire qui célèbre l'héritage africain noir tout en inspirant la prochaine génération de super-héros.",
  ...
  hi: {
    ...
    book_zaiko_subtitle: "वह स��़कों से नहीं उठा। उन्होंने उन पर विजय प्राप्त की।", book_zaiko_desc: "उत्तर किवु में जन्मा।",
    ...
    about_pillar4_title: "बाल पदचिन्ह", about_pillar4_desc: "आइसलेल पढ़ने वाला बच्चा ऐसे स���रक्षकों की खोज करेगा जो उसकी तरह दिखते हैं।",
  ...
  ru: {
    ...
    book_makanda_subtitle: "Самая мощная империя в истории был�� не потеряна. Она была намеренно спрятана.", book_makanda_desc: "Глубоко в Центральной Африке существовала цивилизация, о кото��ой миру никогда не следовало ��знавать.",
    ...
    footer_press: "Пресс", footer_careers: "Карьера", footer_contact: "Контак��", footer_faq: "Часто задаваемые вопросы",
    ...
    about_pillar3_title: "Пробуждение человечества", about_pillar3_desc: "Isolele - это первая часть великой цели, направленной на открытие, изуч��ние и восстановление африканского королевства.",
  ...
  ar: {
    ...
    universe_heritage_title: "الدماء الملكية تحمل القوة القديمة", universe_heritage_desc: "��حتفظ الدماء الملكية ��ذاكرة وقوة الممالك المنسية.",
    ...
    payment_success: "تم الدفع ب��جاح!", payment_receipt_sent: "تم إرسال الإيصال إلى بريدك الإلكتروني",
  ...
  bn: {
    ...
    book_zaiko_subtitle: "তিনি রাস্তা থেকে উঠেন নি। তিনি তাদে��� জয় করেছেন।", book_zaiko_desc: "উত্তর কিভুতে জন্মেছেন।",
    ...
    cta_explore: "অন্ব���ষণ করুন", cta_newsletter: "নিউজলেটার",
    ...
    error: "���্রুটি", success: "সাফল্য", cancel: "বাতিল করুন", save: "সংরক্ষণ করুন", edit: "সম্পাদনা করুন", delete: "মুছুন",
  ...
  ur: {
    ...
    error: "غلطی", success: "کامیابی", cancel: "منسوخ کریں", save: "محفوظ ک��یں", edit: "ترمیم کریں", delete: "حذف کریں",
  ...
  yo: {
    ...
    footer_terms: "Awon ofin", footer_privacy: "Orirede", shop_title: "Ile itaja", shop_subtitle: "Ra awon ohun ṣiṣe alail��gbẹ",
  ...
  am: {
    ...
    news_title: "ዜና", news_read_more: "ተጨ���ሪ ያንብቡ", news_minutes_read: "ደቂቃዎች ያንብቡ", news_published: "ታተመ",
    ...
    about_pillar4_title: "ደጀ እግር", about_pillar4_desc: "ISOLELE ልጅ ��ሮ ���ገኖች ተገኝ ይሆናል.",
    founder_title: "���መስርቶ", founder_name: "ንጉሠ ፊዙ", founder_role: "ISOLELE አለም ተመስርቶ ሕንጻ",
