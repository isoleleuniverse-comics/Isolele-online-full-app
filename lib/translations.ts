...
export interface TranslationKeys {
  ...
  ru: {
    ...
    book_makanda_subtitle: "Самая мощная империя в истории был�� не потеряна. Она была намеренно спрятана.", book_makanda_desc: "Глубоко в Центральной Африке существовала цивилизация, о кото��ой миру никогда не следовало узнавать.",
