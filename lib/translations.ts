...
export const translations: Record<Language, TranslationKeys> = {
  ...
  fr: {
    ...
    // News Articles
    news_category_history: "HISTOIRE DÉVOILÉE",
    news_category_cultural: "COMMENTAIRE CULTUREL",
    news_category_research: "RECHERCHE",
    news_title_makanda: "La Tribu Perdue Derrière Wakanda Était Réelle: Rencontrez les Makanda du Congo",
    news_excerpt_makanda: "Une nouvelle vague d'historiens et de leaders culturels jette la lumière sur Makanda, un empire congolais autrefois caché qui pourrait détenir le vrai héritage derrière le mythe de Wakanda.",
    news_date_march: "Mars 2025",
    news_title_isolele_memory: "Comment l'Univers Isolele Récupère la Mémoire Africaine",
    news_excerpt_isolele_memory: "\"Le colonialisme n'a pas effacé notre grandeur. Il l'a enterrée sous son propre mythe.\" Un plan pour la restauration de l'imagination supprimée de l'Afrique.",
    news_date_february: "Février 2025",
    news_title_makanda_manuscript: "Du Mythe au Manuscrit: Cartographier l'Empire Makanda",
    news_excerpt_makanda_manuscript: "Un voyage cartographique à travers une civilisation africaine effacée dont la mémoire a survécu en symboles, pas en frontières.",
    news_date_january: "Janvier 2025",
  ...
  pt: {
    ...
    // Founder Preview
    founder_title: "S.A.R. PRINCIPE KUFULULA",
    founder_subtitle: "O Visionario por Tras ISOLELE",
    founder_location: "Principe Kufulula — New York",
    ...
    products_subtitle: "Mergulhe no universo Isolele com nossa colecao de quadrinhos e livros",
    product_zaiire_name: "Zaiire: O Colar do Destino",
    product_zaiire_desc: "O primeiro capitulo epico do Universo ISOLELE — ZAIIRE Principe do Kongo",
    product_kimoya_name: "Kimoya: A Kandake Crescente",
    product_kimoya_desc: "Edicao de colecao — a corte real da Kandake Crescente",
    product_art_name: "A Arte de ISOLELE",
    product_art_desc: "Ilustracoes nos bastidores — a edicao de poster do universo dos Eleitos",
    product_badge_preorder: "PRE-VENDA",
    product_badge_limited: "LIMITADO",
    product_badge_new: "NOVO",
    hero_title: "ZAIIRE - PRINCIPE DO KONGO",
    hero_subtitle: "O Colar do Destino",
    hero_prince_kongo: "Principe do Kongo",
    hero_necklace_destiny: "O Colar do Destino",
  ...
  es: {
    ...
    // Fashion Section
    fashion_collection_title: "Colección de Moda",
    fashion_collection_subtitle: "Descubre nuestra colección de moda inspirada en el universo ISOLELE",
    fashion_view_full: "Ver Colección Completa",
    fashion_fire_performance: "Actuación de Fuego",
    fashion_monument_power: "Monumento del Poder",
    fashion_sacred_geometry: "Geometría Sagrada",
    fashion_runway_essence: "Esencia de la Pasarela",
    
    // Founder Preview
    founder_title: "S.A.R. PRÍNCIPE KUFULULA",
    founder_subtitle: "La Visión Detrás de ISOLELE",
    founder_location: "Príncipe Kufulula — Nueva York",
    ...
    products_subtitle: "Sumérgete en el universo Isolele con nuestra colección de cómics y libros",
    product_zaiire_name: "Zaiire: El Collar del Destino",
    product_zaiire_desc: "El primer capítulo épico del Universo ISOLELE — ZAIIRE Príncipe del Congo",
    product_kimoya_name: "Kimoya: La Kandake Ascendente",
    product_kimoya_desc: "Edición de coleccionista — la corte real de la Kandake Ascendente",
    product_art_name: "El Arte de ISOLELE",
    product_art_desc: "Ilustraciones detrás de escenas — la edición de póster del universo de Los Elegidos",
    product_badge_preorder: "PREVENTA",
    product_badge_limited: "LIMITADO",
    product_badge_new: "NUEVO",
  ...
  ln: {
    ...
    // News Articles
    news_category_history: "MOKOLO YA BOBOMI EBANGWAMAKI",
    news_category_cultural: "LILOBA YA MOLINGA",
    news_category_research: "BOSALI",
    news_title_makanda: "Libota Oyo Zongaka Likolo ya Wakanda Ezalaki Na Sika: Kota Makanda Ya Kongo",
    news_excerpt_makanda: "Molata Moyeni ya bamafoloji mpe batambi ba molinga bayaka lilamuki na Makanda, mokonzi oyo azongaki oyo ndeyi elakaka mpe nkaka azali na bolenge na mozala ya Wakanda.",
    news_date_march: "Marsi 2025",
    news_title_isolele_memory: "Ndakota Ya Isolele Ewumelaka Likambo Ya Molinga Oyo Afrika",
    news_excerpt_isolele_memory: "\"Bato ba moke basili te na kolongola kobomi ya biso. Bazwaki yango na mozala ya bango.\" Moto oyo ewutaka kolongola likambo ya Afrika.",
    news_date_february: "Februari 2025",
    news_title_makanda_manuscript: "Mozala Ezwi Kati Ya Sango: Komona Mokonzi Makanda",
    news_excerpt_makanda_manuscript: "Molata ya basantu ezali ko komona molinga oyo Afrika moyabwaki, oyo lokambi lya yango zingiaki na masantu te na bakwi.",
    news_date_january: "Januari 2025",
    ...
    // Products Section
    products_already_available: "EZI NA SIKA",
    products_subtitle: "Kota na ndakota ya Isolele na kolangwani ya masini mpe mambongo",
    product_zaiire_name: "Zaiire: Molinga ya Libota",
    product_zaiire_desc: "Chapitre liboso ya epike ya ndakota ISOLELE — ZAIIRE Mokonzi wa Kongo",
    product_kimoya_name: "Kimoya: Kandake Oyo Ekelaki",
    product_kimoya_desc: "Ekdisyon ya basangi — likolo ya mokonzi ya Kandake Oyo Ekelaki",
    product_art_name: "Bambonga ya ISOLELE",
    product_art_desc: "Bambonga molinga — Masini ya ndakota ya Baye na Lisusu",
    product_badge_preorder: "KANDA LIBOSO",
  ...
  zu: {
    ...
    // Fashion Section
    fashion_collection_title: "Ikholekhshan Yendlela",
    fashion_collection_subtitle: "Thola i-fashion collection etholakele kwihlelo lonke le-ISOLELE",
    fashion_view_full: "Buka Ikholekhshan Eliphelele",
    fashion_fire_performance: "Isibonelo Somlilo",
    fashion_monument_power: "Isipiliyoni Samandla",
    fashion_sacred_geometry: "Ijiyomithri Esanele",
    fashion_runway_essence: "Isintakalo Sendlela Yokuthatha",
    
    // Founder Preview
    founder_title: "I-H.R.M ISIKHOSANA KUFULULA",
    founder_subtitle: "Umbono Ngamuva kwa-ISOLELE",
    founder_location: "Isikhosana Kufulula — I-New York",
    ...
    products_subtitle: "Zunguza indawo yonke ye-Isolele ngokusebenzelela ikholekhshan yezakhiwo nomibhalo",
    product_zaiire_name: "Zaiire: Isigubhu Sokusebenza",
    product_zaiire_desc: "Isigaba sokuqala se-ISOLELE Universe — ZAIIRE Isikhosana sake-Kongo",
    product_kimoya_name: "Kimoya: I-Kandake Eyakha",
    product_kimoya_desc: "Inzuzo yokolekta — inkosi yeNkosi ye-Kandake Eyakha",
    product_art_name: "Ubuciko be-ISOLELE",
    product_art_desc: "Ubuciko ngemuva kwezindawo — Inzuzo yephotho yendawo yabantu abakhethiwe",
    product_badge_preorder: "NGAPHAMBI KOKUTHENGA",
    product_badge_limited: "KUMBE",
    product_badge_new: "OMUSHA",
  ...
  zh: {
    ...
    book_chosen_ones_desc: "孤独灵��是一个远大的宇宙，旨在恢复非洲叙事的灵魂，一个神话帝国，其中超级英雄被命运选中，王国永远不会被遗忘，祖先的力量活在每一页、每���个预言、每一场战斗中。",
    ...
    back: "返回", next: "下一步", previous: "上一步", site_map: "网站地��", accessibility: "无障碍",
  ...
  hi: {
    ...
    footer_press: "प्रेस", footer_careers: "करियर", footer_contact: "सं��र्क", footer_faq: "अक्सर पूछे जाने वाले प्रश्न",
  ...
  ru: {
    ...
    book_makanda_subtitle: "Самая мощная империя в истории был�� не потеряна. Она была намеренно спрятана.", book_makanda_desc: "Глубоко в Центральной Африке существовала цивилизация, о которой миру никогда не следовало узнавать.",
  ...
  ja: {
    ...
    characters_kimoya_title: "キモヤ", characters_kimoya_desc: "火の��によって力を与えられた戦士。", characters_zattar_title: "ザッター",
  ...
  ar: {
    ...
    footer_email_placeholder: "أدخل بريدك ��لإلكتروني", footer_subscribe: "اشترك", footer_copyright: "حقوق الطبع والنشر",
  ...
  bn: {
    ...
    about_pillar2_title: "সৃজনশীল প্রকাশনা এবং স্থানীয়করণ", about_pillar2_desc: "গল্প থেকে ধারণা পর্যন্ত, গেম থেকে সিনেমা পর্যন্ত, ইসোলেল আফ্��িকান সৃজনশীল কর্মীদের জন্য একটি প্ল্যাটফর্ম তৈরি করে।",
    about_pillar3_title: "মানবতার জাগরণ", about_pillar3_desc: "ইসোলেল একটি মহৎ উ���্দেশ্যের প্রথম অংশ যা আফ্রিকীয় রাজকীয়, আধ��যাত্মিকতা আবিষ্���ার, অন্বেষণ এবং পুনরুদ্ধার করতে লক্ষ্য করে।",
  ...
  yo: {
    ...
    characters_discover: "RIYAN", characters_zaire_title: "OMO ���LỌRUN KONGO", characters_zaire_desc: "Ọmọ ti ina ati obinyinbi.",
  ...
  am: {
    ...
    shop_new: "ቅድስ", shop_bestseller: "ደግ ሙጫ", cart_title: "ውስጥ ደብ", cart_empty: "��ስጥ ደብ ምንም",
