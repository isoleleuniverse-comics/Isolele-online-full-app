...
export const translations: Record<Language, TranslationKeys> = {
  ...
  xh: {
    ...
    book_chosen_ones_desc: "I-Isolele yindalo enomdla eyazalwa ukubuyisela umphefumlo webali lase-Afrika.",
    ...
    book_makanda_desc: "Kwixesha elidlulileyo ene-Afrika, kwakhona omnye umntu okwayenazange wayazi umhlaba.",
    ...
    book_bambula_desc: "Phambi kwamabali, kwakukho umsindo.",
    book_discover_bambula: "FUMANA BAMBULA",

    book_mokele_tag: "MOKELE: WAZALWA EKULWANENI",
    book_mokele_title: "MOKELE",
    book_mokele_subtitle: "Ukusuka kumntwana ukuya kumNkosi weKinshasa",
    book_mokele_desc: "UMokele wayenazange wazalwa njengomNkosi.",
    ...
    book_zaiire_desc: "Enkulu-inzalo yabalindwa ngabantu abaninzi noxolo.",
    ...
    book_kufu_desc: "Ayisosindisi kuphela i-card game.",
    ...
    book_amara_desc: "Wonke umqwebu uyatshaba olulamda.",
    book_discover_amara: "FUMANA AMARA",

    book_zattar_tag: "ZATTAR: INKOSANA YEINDALO",
    book_zattar_title: "ZATTAR",
    book_zattar_subtitle: "Umhweli WeEenthasi",
    book_zattar_desc: "Xa umoya wayikhangelisa umnye ubukhosi.",
    ...
    book_zaiko_desc: "Wazalwa eKivu Esentshonalanga.",
  ...
  ln: {
    ...
    book_chosen_ones_desc: "Isolele ezali mokili moko ya boyebi oyo ebotamaki mpo na kozongisa molimo ya masolo ya Afrika.",
    ...
    book_makanda_desc: "Kati ya Afrika Etikali, ezalaki na nkolo oyo mokili yazangi koyeba.",
    book_discover_makanda: "YEBA MAKANDA",

    book_bambula_tag: "BAMBULA: MWANA YA RITEM",
    book_bambula_title: "BAMBULA",
    book_bambula_subtitle: "CHAPIT I · LIBANGA LISAKOLI",
    book_bambula_desc: "Liboso ya nzembo, ezalaki ritem.",
    ...
    book_mokele_desc: "Mokele azali kobotama te lokola Mokonzi.",
    ...
    book_zaiire_desc: "Eyalembwe na likita ya Bokonzi ya Kongo, Singa ya Mokano eyalembwe mpo azali mwa esengo.",
    ...
    book_kufu_desc: "Eyokatani te kuphela na mosolo ya kadi.",
    ...
    book_zaiko_desc: "Azali na Kivu Nzela ya Nor.",
    ...
    about_pillar3_desc: "ISOLELE ezali esango ya liboso ya moninga monene oyo ezongiselaka, kofuta, mpe kozongisa mokili, molimo ya Afrika.",
    ...
    founder_role: "Mosungi mpe mozangi ya Isolele Universe",
    founder_bio: "Muninga oyo azali likolo ya ISOLELE, oziniki mpe na kozongisa molimo ya masolo ya Afrika mape.",
  ...
  hi: {
    ...
    hero_title: "जायरे - कांगो के राजकुमा���", hero_subtitle: "नियति का हार", hero_description: "एक प्रेरणादायक कार्य-संचालित साहसिक कथा जो द लायन किंग और ब्लैक पैंथर की भावना को प्रतिध्वनित करती है।",
