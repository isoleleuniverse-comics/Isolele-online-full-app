export const BOOKSTORE_DISPLAY_IMAGE_BLUR_DATA_URL =
...
export const bookstoreDisplayData = {
  en: {
    headingTagline: "In Stores Now",
    ...
    // updated image path to the user-provided PNG
    imageSrc: "/images/buy-now-covers.png",
