...
export const storyData = {
  en: {
  founderLabel: "Creator & Author",
  title: "THE PRINCE OF KONGO: THE NECKLACE OF DESTINY",
  ...
  paragraphs: [
    ...
    "\"The Prince of Kongo: Necklace of Destiny\" tells the epic story of Zaiire, a young boy from the bustling city of Kinshasa, raised in a life of unimaginable wealth and privilege.",
    ...
    "During their reunion, his mother entrusts him with the Necklace of Destiny, a mystical artifact passed down through generations of Congolese royalty.",
  ],
