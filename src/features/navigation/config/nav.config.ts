...
import { BookOpen, Gamepad2, Home, ShoppingBag, UtensilsCrossed, Users } from "lucide-react";
...
export const NAV_LINKS: NavLink[] = [
  ...
  { key: "nav_shop", href: "/shop", icon: ShoppingBag },
  { key: "nav_restaurant", href: "/restaurant", icon: UtensilsCrossed },
];
