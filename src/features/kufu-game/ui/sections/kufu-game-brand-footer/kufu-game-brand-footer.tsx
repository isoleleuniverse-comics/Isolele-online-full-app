...
export function KufuGameBrandFooter() {
  return (
    <motion.div
    ...
    >
      <Image src={KUFU_ASSETS.logo} alt="ISOLELE" width={40} height={40} className="object-contain" />
      <div>
        <p className="text-sm font-bold" style={{ color: "#F6B800" }}>
          ISOLELE STUDIOS
        </p>
