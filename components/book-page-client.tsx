...
// POS Invoice overlay shown after successful payment (for /success page)
      ...
      >
        ...
        <div className="p-6 font-mono text-sm">
          ...
          <div className="text-center mb-4">
            ...
            <p className="text-xs text-gray-500 uppercase tracking-widest mt-1">The Chosen Ones</p>
            <p className="text-xs text-gray-400">universe.isolele.com</p>
...
export function BookPageClient({ book }: BookPageClientProps) {
  ...
  const handlePayNow = async () => {
    ...
    setLoading(true)
    try {
      const url = await startBookCheckoutSession(book.id, emailInput)
  ...
  return (
    ...
    >
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <Link href="/shop">
          <motion.span
            className="inline-flex items-center gap-2 mb-8 px-4 py-2 rounded-lg text-sm font-semibold cursor-pointer"
            style={{
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-16 items-start">
          ...
          >
            <div
              ...
              style={{ border: `4px solid ${book.accentColor}40` }}
            >
              <Image
                src={book.coverImage}
                alt={book.name}
          ...
          >
            ...
            <div className="flex items-center gap-2">
              {[...Array(5)].map((_, i) => (
                <Star key={i} size={18} fill={book.accentColor} color={book.accentColor} />
              ))}
            ...
            {/* Description */}
            <p className="text-base leading-relaxed" style={{ color: currentTheme.colors.textSecondary }}>
              {book.description}
            </p>
            ...
            <div className="flex flex-col gap-3 mt-2">
              <span className="text-4xl font-black" style={{ color: book.accentColor }}>
              ...
              <input
                ...
                style={{
                  ...
                  borderColor: emailError ? "#e53e3e" : `${book.accentColor}40`,
              ...
              <motion.button
                ...
                disabled={loading}
                className="flex items-center justify-center gap-2 py-4 px-6 rounded-xl font-black text-base uppercase tracking-widest shadow-lg disabled:opacity-60 disabled:cursor-not-allowed transition-opacity"
                style={{ backgroundColor: book.accentColor, color: "#fff" }}
              >
                {loading ? (
        ...
        >
          ...
          <div className="space-y-4">
            {reviews.map((review, idx) => (
              <div key={idx} className="p-5 rounded-xl" style={{ backgroundColor: `${book.accentColor}0D` }}>
