...
export function FounderPreview() {
  ...
  const content = {
    ...
    fr: {
      ...
      description: "Architecte culturel et conteur, le Roi Kufulula a fondé ISOLELE pour restaurer l'âme du storytelling africain. Sa vision est de créer un empire mythologique où les super-héros africains émergent de l'histoire authentique.",
      quote: "Nous ne créons pas seulement des personnages. Nous créons une lignée. Nous créons un héritage.",
