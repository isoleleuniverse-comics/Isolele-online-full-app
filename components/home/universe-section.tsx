          ...
          {pillars.map((pillar, index) => (
            ...
            >
              ...
              <div className="relative mb-6">
                ...
                {/* Animated burning fire with turquoise and ashes for third pillar (Royal) */}
                {index === 2 && (
                  <div className="absolute -top-3 -right-3 w-10 h-10">
                    ...
                    <motion.div
                      ...
                      style={{
                        filter: 'drop-shadow(0 0 6px #1E9B8A) drop-shadow(0 0 12px #20B2AA) drop-shadow(0 0 18px #F6B800) drop-shadow(0 0 25px #FF6B35)',
                      }}
                    >
                      <Flame 
                        className="w-8 h-8"
                    ...
                    {/* Secondary flame - golden/orange overlay */}
                    <motion.div
                      className="absolute top-0 left-0"
                      animate={{
                        scale: [1.1, 0.9, 1.2, 1],
                        opacity: [0.7, 0.9, 0.6, 0.8],
                        rotate: [-2, 4, -3, 1],
                      }}
                      transition={{ duration: 0.6, repeat: Infinity, delay: 0.1 }}
                      style={{
                        filter: 'drop-shadow(0 0 8px #F6B800) drop-shadow(0 0 15px #FF4500)',
                      }}
                    >
                      <Flame 
                        className="w-8 h-8"
                        style={{ color: '#F6B800', opacity: 0.6 }}
                      />
                    </motion.div>
                  </div>
                )}
