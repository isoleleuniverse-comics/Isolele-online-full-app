...
export default function ZattarPage() {
  ...
  const book = {
    ...
    fullDescription: "Enter a world of dark magic and ancient secrets. Zattar, master of blood rituals and forgotten arts, walks the thin line between power and corruption. With stunning gothic artwork and mind-bending storylines, this comic explores themes of sacrifice, redemption, and the cost of wielding forbidden magic in service of protecting one's people.",
    pages: 192,
    language: "English/Français",
    format: "Digital Comic / Hardcover",
    isbn: "978-0-ISOLELE-003",
    tags: ["Dark Fantasy", "Magic", "Mystery", "African Mysticism", "Adult"]
  }

  const reviews = [
    { name: "Kofi A.", rating: 5, text: "Zattar is dark, compelling, and beautifully illustrated. A masterpiece." },
    { name: "Anika R.", rating: 4, text: "Great storyline. The magic system is unique and well thought out." },
    { name: "Marcus D.", rating: 5, text: "This is what African fantasy should look like. Powerful stuff." },
  ]
